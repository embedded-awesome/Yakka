...
const std::vector<std::shared_ptr<blueprint_match>>& target_database::add_target(const std::string target, blueprint_database &blueprint_database, ryml::Tree project_summary)
{
